...
from scripts.case.logic.url_checker import check_url_validity
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="행정해석 목록 URL의 유효성을 검증합니다.")
    parser.add_argument("url", help="검증할 행정해석 목록 페이지의 전체 URL")
