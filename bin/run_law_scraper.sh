...
rm -f "${URL_LIST_FILE}"
rm -rf "${RAW_DATA_DIR:?}"/*
mkdir -p "${RAW_DATA_DIR}" "${FINAL_DATA_DIR}"
...
cat "${RAW_DATA_DIR}"/*_document.jsonl > "${FINAL_DATA_DIR}/${DEPT_CODE}_documents.jsonl"
cat "${RAW_DATA_DIR}"/*_chunks.jsonl > "${FINAL_DATA_DIR}/${DEPT_CODE}_chunks.jsonl"

echo "'${FINAL_DATA_DIR}/${DEPT_CODE}_documents.jsonl' 생성 완료"
echo "'${FINAL_DATA_DIR}/${DEPT_CODE}_chunks.jsonl' 생성 완료"
